...
pub struct CustomFieldCreateRequestCardPicker {
...
impl CustomFieldCreateRequestCardPicker {
    pub fn new(name: String, r#type: Type) -> CustomFieldCreateRequestCardPicker {
