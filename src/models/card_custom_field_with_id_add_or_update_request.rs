...
pub struct CardCustomFieldWithIdAddOrUpdateRequest {
...
impl CardCustomFieldWithIdAddOrUpdateRequest {
    pub fn new(field_id: i32) -> CardCustomFieldWithIdAddOrUpdateRequest {
