...
/// CreateManyCardsRequest : Cards data.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateManyCardsRequest {
    /// A list of cards data.
    #[serde(rename = "cards")]
    pub cards: Vec<crate::models::CardCreateRequest>,
    ...
    /// The user id of the reporter if the cards are created on behalf of someone else.
    ...
    /// The email of the reporter if the cards are created on behalf of someone else without a known user id.
...
impl CreateManyCardsRequest {
    /// Cards data.
    pub fn new(cards: Vec<crate::models::CardCreateRequest>) -> CreateManyCardsRequest {
