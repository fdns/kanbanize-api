...
pub struct BoardCustomFieldCreateOrUpdateRequestFile {
...
impl BoardCustomFieldCreateOrUpdateRequestFile {
    pub fn new() -> BoardCustomFieldCreateOrUpdateRequestFile {
