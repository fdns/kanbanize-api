...
/// CardCustomFieldDataContributor : Card custom field data - contributor



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CardCustomFieldDataContributor {
...
impl CardCustomFieldDataContributor {
    /// Card custom field data - contributor
    pub fn new() -> CardCustomFieldDataContributor {
