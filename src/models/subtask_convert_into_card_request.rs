...
/// SubtaskConvertIntoCardRequest : Subtask convert into card data.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SubtaskConvertIntoCardRequest {
...
impl SubtaskConvertIntoCardRequest {
    /// Subtask convert into card data.
    pub fn new(subtask_id: i32) -> SubtaskConvertIntoCardRequest {
