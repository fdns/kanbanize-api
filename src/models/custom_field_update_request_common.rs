...
/// CustomFieldUpdateRequestCommon : Custom field data.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomFieldUpdateRequestCommon {
...
impl CustomFieldUpdateRequestCommon {
    /// Custom field data.
    pub fn new() -> CustomFieldUpdateRequestCommon {
