...
pub struct CreateCardRequest {
    ...
    /// The user id of the reporter if the card is created on behalf of someone else.
    ...
    /// The email of the reporter if the card is created on behalf of someone else without a known user id.
