...
/// AddCardTemplateCardSuccessorCardRequest : Link data.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AddCardTemplateCardSuccessorCardRequest {
...
impl AddCardTemplateCardSuccessorCardRequest {
    /// Link data.
    pub fn new() -> AddCardTemplateCardSuccessorCardRequest {
        AddCardTemplateCardSuccessorCardRequest {
