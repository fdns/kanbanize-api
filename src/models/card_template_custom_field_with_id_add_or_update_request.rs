...
pub struct CardTemplateCustomFieldWithIdAddOrUpdateRequest {
...
impl CardTemplateCustomFieldWithIdAddOrUpdateRequest {
    pub fn new(field_id: i32) -> CardTemplateCustomFieldWithIdAddOrUpdateRequest {
