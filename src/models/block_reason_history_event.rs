...
/// BlockReasonHistoryEvent : An event recorded when an update, delete or create action is executed on block reasons resource



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BlockReasonHistoryEvent {
