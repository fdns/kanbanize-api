...
pub struct CardCommentDataAuthorOrSenderAndRecipient {
...
impl CardCommentDataAuthorOrSenderAndRecipient {
    pub fn new() -> CardCommentDataAuthorOrSenderAndRecipient {
