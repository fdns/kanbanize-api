...
/// CardTemplatePrimaryCardCreateRequest : Primary card data for a card template.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CardTemplatePrimaryCardCreateRequest {
...
impl CardTemplatePrimaryCardCreateRequest {
    /// Primary card data for a card template.
    pub fn new() -> CardTemplatePrimaryCardCreateRequest {
