...
/// StickerHistoryEvent : An event recorded when an update, delete or create action is executed on stickers resource



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StickerHistoryEvent {
