...
/// CreateDiscardReasonRequest : Discard reason data.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateDiscardReasonRequest {
    /// The discard reason.
    #[serde(rename = "label")]
    pub label: String,
...
impl CreateDiscardReasonRequest {
    /// Discard reason data.
    pub fn new(label: String) -> CreateDiscardReasonRequest {
