...
pub struct CardTemplateCardInExistingTemplateCreateRequest {
...
impl CardTemplateCardInExistingTemplateCreateRequest {
    pub fn new(column_id: i32, lane_id: i32) -> CardTemplateCardInExistingTemplateCreateRequest {
