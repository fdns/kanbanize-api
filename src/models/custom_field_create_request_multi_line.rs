...
pub struct CustomFieldCreateRequestMultiLine {
...
impl CustomFieldCreateRequestMultiLine {
    pub fn new(name: String, r#type: Type) -> CustomFieldCreateRequestMultiLine {
