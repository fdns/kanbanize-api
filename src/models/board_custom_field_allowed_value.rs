...
/// BoardCustomFieldAllowedValue : Board custom field allowed value data



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BoardCustomFieldAllowedValue {
...
impl BoardCustomFieldAllowedValue {
    /// Board custom field allowed value data
    pub fn new() -> BoardCustomFieldAllowedValue {
