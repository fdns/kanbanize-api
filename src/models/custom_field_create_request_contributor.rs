...
pub struct CustomFieldCreateRequestContributor {
...
impl CustomFieldCreateRequestContributor {
    pub fn new(name: String, r#type: Type) -> CustomFieldCreateRequestContributor {
