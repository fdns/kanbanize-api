...
pub struct GetBoardCustomFields200ResponseDataInner {
    /// Field id.
...
impl GetBoardCustomFields200ResponseDataInner {
    pub fn new() -> GetBoardCustomFields200ResponseDataInner {
        GetBoardCustomFields200ResponseDataInner {
            field_id: None,
            position: None,
            color: None,
