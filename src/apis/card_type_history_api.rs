...
/// struct for typed errors of method [`get_card_types_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCardTypesHistoryError {
...
pub async fn get_card_types_history(configuration: &configuration::Configuration, type_ids: Option<Vec<i32>>, user_ids: Option<Vec<i32>>, event_types: Option<Vec<String>>, from: Option<String>, to: Option<String>, from_date: Option<String>, to_date: Option<String>, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::GetCardTypesHistory200Response, Error<GetCardTypesHistoryError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/cardTypes/history", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCardTypesHistoryError> = serde_json::from_str(&local_var_content).ok();
