...
/// struct for typed errors of method [`get_boards_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBoardsHistoryError {
...
pub async fn get_boards_history(configuration: &configuration::Configuration, board_ids: Option<Vec<i32>>, user_ids: Option<Vec<i32>>, event_types: Option<Vec<String>>, from: Option<String>, to: Option<String>, from_date: Option<String>, to_date: Option<String>, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::GetBoardsHistory200Response, Error<GetBoardsHistoryError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/boards/history", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBoardsHistoryError> = serde_json::from_str(&local_var_content).ok();
