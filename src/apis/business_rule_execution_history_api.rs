...
/// struct for typed errors of method [`get_business_rules_execution_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetBusinessRulesExecutionHistoryError {
...
pub async fn get_business_rules_execution_history(configuration: &configuration::Configuration, business_rule_ids: Option<Vec<i32>>, executed_on_card_ids: Option<Vec<i32>>, from: Option<String>, to: Option<String>, from_date: Option<String>, to_date: Option<String>, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::GetBusinessRulesExecutionHistory200Response, Error<GetBusinessRulesExecutionHistoryError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/businessRules/executionHistory", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBusinessRulesExecutionHistoryError> = serde_json::from_str(&local_var_content).ok();
