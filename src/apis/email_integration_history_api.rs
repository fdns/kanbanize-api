...
/// struct for typed errors of method [`get_email_integration_history`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEmailIntegrationHistoryError {
...
pub async fn get_email_integration_history(configuration: &configuration::Configuration, sender: Option<&str>, receiver: Option<&str>, status: Option<&str>, from: Option<String>, to: Option<String>, from_date: Option<String>, to_date: Option<String>, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::GetEmailIntegrationHistory200Response, Error<GetEmailIntegrationHistoryError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/emailIntegration/history", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmailIntegrationHistoryError> = serde_json::from_str(&local_var_content).ok();
